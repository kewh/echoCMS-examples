-- echoCMS-examples
-- https://github.com/kewh/echoCMS-examples
--
-- database setup for examples
-- ---------------------------
-- for see README for setup instructions
...
INSERT INTO `itemsTable` (`id`, `pending_id`, `created`, `createdBy`, `updated`, `updatedBy`, `status`, `date`, `topic`, `subtopic`, `heading`, `caption`, `text`, `video`, `download_src`, `download_name`) VALUES
